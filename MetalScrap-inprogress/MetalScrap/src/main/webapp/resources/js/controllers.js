...
function UserDetails($scope, $modalInstance, $http) {
	...
	$scope.user = {"login":"krzaq4", "firstName":"Michał"} ;
...
function Categories($scope, $http, auctionService){
	...
	$scope.gridOptions = { data: 'getA()', columnDefs: [{field:'name', displayName:'Nazwa aukcji'}, {field:'from', displayName:'Data rozpoczęcia'}, {field:'to', displayName:'Data zakończenia'},{field:'price', displayName:'Aktualna cena'}, {field:'end', displayName:'Do końca aukcji'}] };
}
